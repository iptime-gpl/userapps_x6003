/* $Id: miniupnpc.c,v 1.2 2011/12/01 10:38:37 gemnas Exp $ */
/* Project : miniupnp
...
UPNPIGD_IsConnected(struct UPNPUrls * urls, struct IGDdatas * data)
{
	...
	UPNP_GetStatusInfo(urls->controlURL, data->first.servicetype,
	                   status, &uptime, NULL);
#ifdef USE_EFM_PATCH
	// always return as connected.
	return 1;
#endif // USE_EFM_PATCH
	if(0 == strcmp("Connected", status))
	{
		printf("=====================> UPNPIGD_IsConnected : connected \n");
		return 1;
	}
	else
	{
		printf("=====================> UPNPIGD_IsConnected : not connected \n");
		return 0;
	}
}
