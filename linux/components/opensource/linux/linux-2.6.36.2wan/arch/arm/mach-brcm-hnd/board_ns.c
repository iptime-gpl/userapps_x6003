...
#ifdef CONFIG_EFM_PATCH
#ifndef CONFIG_EFM_PATCH2
        bcm947xx_flash_parts[nparts].name = "save";
        bcm947xx_flash_parts[nparts].size = ROUNDUP(nvram_space, mtd->erasesize);
        bcm947xx_flash_parts[nparts].offset = size - bcm947xx_flash_parts[nparts].size * 2;
        nparts++;
#endif
        bcm947xx_flash_parts[nparts].name = "all";
        bcm947xx_flash_parts[nparts].size = size;
